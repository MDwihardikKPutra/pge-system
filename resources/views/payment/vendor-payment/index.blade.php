                    ...
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                @endif
                                @if($vp->status->value === 'approved')
                                    <a href="{{ route($isAdmin ? 'admin.vendor-payments.pdf' : 'user.vendor-payments.pdf', $vp) }}" target="_blank" class="inline-flex items-center gap-1 text-green-600 hover:text-green-800 text-xs font-medium transition-colors">
