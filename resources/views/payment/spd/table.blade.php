                    ...
                    <td class="px-4 py-3 text-center">
                        <div class="flex items-center justify-center gap-2">
                            ...
                            @if($spd->status->value === 'approved')
                                <a href="{{ route((auth()->user()->hasRole('admin') ? 'admin' : 'user') . '.spd.pdf', $spd) }}" target="_blank" class="inline-flex items-center gap-1 text-green-600 hover:text-green-800 text-xs font-medium transition-colors">
