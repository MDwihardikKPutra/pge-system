                    ...
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="flex items-center justify-center gap-2">
                                @php
                                    $canView = auth()->user()->can('view', $spd);
                                    $canUpdate = auth()->user()->can('update', $spd);
                                    $canDelete = auth()->user()->can('delete', $spd);
                                @endphp
                                @if($canView)
                                ...
                                @if($spd->status->value === 'approved')
                                    <a href="{{ route($isAdmin ? 'admin.spd.pdf' : 'user.spd.pdf', $spd) }}" target="_blank" class="inline-flex items-center gap-1 text-green-600 hover:text-green-800 text-xs font-medium transition-colors">
