...
@section('title', 'Buat Realisasi Kerja')
@section('page-title', 'Buat Realisasi Kerja')
@section('page-subtitle', 'Catat pencapaian kerja Anda')
...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-3 mb-4">
        ...
        <h1 class="text-2xl font-bold text-slate-800">Buat Realisasi Kerja</h1>
    </div>

    <form action="{{ route('user.work-realizations.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div class="bg-white shadow-sm rounded-lg border border-slate-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="date" id="realization_date" name="realization_date" value="{{ old('realization_date') }}" required
            ...
            <div class="mt-4">
                ...
                <select id="work_plan_id" name="work_plan_id" class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500">
                    ...
                    @foreach($workPlans as $plan)
                        <option value="{{ $plan->id }}" {{ old('work_plan_id') == $plan->id ? 'selected' : '' }}>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div>
                    ...
                    <input type="number" id="actual_duration_hours" name="actual_duration_hours" value="{{ old('actual_duration_hours') }}" 
                ...
                <div>
                    ...
                    <input type="number" id="progress_percentage" name="progress_percentage" value="{{ old('progress_percentage', 0) }}" 
        ...
        <div class="bg-white shadow-sm rounded-lg border border-slate-200 p-6">
            ...
            <div class="mt-4">
                ...
                <textarea id="output_description" name="output_description" rows="3"
                    ...
                    class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500">{{ old('output_description') }}</textarea>
            </div>
