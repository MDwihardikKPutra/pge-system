...
<div class="py-8 w-full">
  <div class="flex flex-wrap items-end justify-between mb-6 gap-3">
    ...
    <a href="{{ route('admin.approvals.leaves') }}" class="border border-gray-300 text-gray-700 px-4 py-2 rounded hover:bg-gray-100 text-sm">← Kembali</a>
  </div>
  ...
  <div class="border rounded bg-white p-5 mb-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
      ...
      <div>
        ...
        <div class="font-semibold text-gray-900">{{ $leave->total_days }} hari</div>
      </div>
    </div>
    ...
    <div class="mt-4 pt-4 border-t">
      ...
      <div class="flex items-center justify-between bg-gray-50 p-3 rounded">
        ...
        <a href="{{ route('admin.approvals.leaves.attachment.download', $leave->id) }}" download class="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded text-xs font-medium transition-colors">
    ...
    <div class="border rounded bg-white p-5 mb-4">
      <div class="flex items-center justify-between mb-4">
        ...
        @if($leave->isApproved() && $leave->pdf_path)
          <a href="{{ route('admin.leaves.pdf', $leave->id) }}" 
  ...
  @if($leave->isPending())
    <div class="border rounded bg-white p-5">
      ...
      <form action="{{ route('admin.approvals.leaves.approve', $leave) }}" method="POST" class="mb-3">
        @csrf
        <div class="mb-3">
      ...
      <form action="{{ route('admin.approvals.leaves.reject', $leave) }}" method="POST">
        @csrf
        <div class="mb-3">
